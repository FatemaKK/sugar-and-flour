...
### deployed front-end link : https://sugar-and-flour.netlify.app/

Store App - a single model CRUD app API, using RESTful routes and consuming it with a create-react-app front-end.
